(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('@angular/material/core'), require('moment')) :
    typeof define === 'function' && define.amd ? define('@angular/material-moment-adapter', ['@angular/core','exports', '@angular/core', '@angular/material/core', 'moment'], factory) :
    (global = global || self, factory(global.ng.core,(global.ng = global.ng || {}, global.ng.materialMomentAdapter = {}), global.ng.core, global.ng.material.core, global.moment));
}(this, (function (ɵngcc0,exports, core, core$1, _rollupMoment) { 'use strict';
...
MomentDateAdapter.ɵfac = function MomentDateAdapter_Factory(t) { return new (t || MomentDateAdapter)(ɵngcc0.ɵɵinject(core$1.MAT_DATE_LOCALE, 8), ɵngcc0.ɵɵinject(MAT_MOMENT_DATE_ADAPTER_OPTIONS, 8)); };
...
MatMomentDateModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function MatMomentDateModule_Factory(t) { return new (t || MatMomentDateModule)(); }, providers: [{ provide: core$1.MAT_DATE_FORMATS, useValue: ɵ0 }], imports: [[MomentDateModule]] });
